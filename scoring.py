...
def best_overall(places: List[Dict[str, Any]]) -> Dict[str, Any]:
    '''
...
def best_cheap_option(places: List[Dict[str, Any]]) -> Dict[str, Any]:
    '''
    ...
    '''
    cheap_places = [p for p in places if (p.get("price_level") or 4) <= 1]
...
def pick_hidden_gem(places: List[Dict[str, Any]], max_reviews: int = 70) -> Optional[Tuple[Dict[str, Any], str]]:
    '''
